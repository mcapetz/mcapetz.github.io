...
//   }
  ...
  return (
    <div className="z-10 sticky top-0 pt-10 px-10 sm:px-20">
        <div className="flex flex-row justify-between">
            <div className="sm:h-20 sm:w-20 h-7 w-7 bg-main hover:rotate-12 duration-300 rounded-md hover:bg-black hover:text-white align-middle text-center sm:pt-5 pt-1 text-sm sm:text-2xl" onClick={() => {window.location.href = "/"}}>
                mc.
            </div>
            <div className="flex flex-row px-5 gap-5 sm:gap-10 self-center">
              <Link to="/story" className="hover:italic text-md sm:text-xl">story.</Link>
              <Link to="/projects" className="hover:italic text-md sm:text-xl">projects.</Link>
              <Link to="/contact" className="hover:italic text-md sm:text-xl">contact.</Link>
            </div>
        </div>
    </div>
